---
title: "Analysis : exp234-242 g_Ca dynamic reactivation"
...
I turned d(g_Ca)/dt back on but don't have record of confirming everything way. I've been using sims without it...
```{r, message=FALSE}
# -----------------------------------------------------------------------
# 16: Burst E, with H
exp_code <- 238
