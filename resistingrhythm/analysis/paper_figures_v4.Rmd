...
## FI curve
```{r, message=FALSE}
results_fi <- read_csv("../ipynb/FI_curves.csv")
```
...
bind_rows(results220, results222) %>%
  ...
  ggplot(mapping=aes(x=osc_rate, y=M, color=synapse)) +
    geom_line(size=0.8) +
    geom_point(size=1.5) +
    geom_linerange(mapping=aes(x=osc_rate, ymin=M - SD, ymax=M + SD, color=synapse)) +
    scale_color_manual(values=c("black", "grey")) +
    lims(y=c(0.0, 0.2)) +
    labs(title="b.", y="Kappa", x="Osc. modulation") +
    theme_classic2() +
...
bind_rows(results221, results223) %>% 
  ...
  ggplot(mapping=aes(x=osc_rate, y=M, color=synapse)) +
    ...
    scale_color_manual(values=c("black", "grey")) +
    lims(y=c(0.0, 0.2)) +
    labs(title="d.", y="Kappa", x="Osc. modulation") +
    theme_classic2() +
    theme(plot.title = element_text(hjust = -.3, size=18, face="bold"),
...
bind_rows(results220, results222) %>% 
  ...
  geom_linerange(mapping=aes(x=osc_rate, ymin=M - SD, ymax=M + SD, color=synapse),
                width=.15, size=0.2) +
  scale_color_manual(values=c("black", "grey")) +
  labs(title="a.", y="Pop. rate", x="Osc. modulation") +
  lims(y=c(0.0, 180.0)) +
...
bind_rows(results221, results223) %>% 
  ...
  labs(title="c.", y="Pop. rate", x="Osc. modulation") +
  lims(y=c(0.0, 180.0)) +
  theme_classic2() +
  theme(
...
bind_rows(results224, results227)  %>% 
  ...
  ggplot(mapping=aes(x=osc_rate, y=M, color=synapse)) +
    ...
    lims(y=c(0.0, 0.2)) +
    labs(title="f.", y="Kappa", x="Osc. modulation") +
    theme_classic2() +
    theme(plot.title = element_text(hjust = -.3, size=18, face="bold"),
...
bind_rows(results224, results227)  %>% 
  ...
  ggplot(mapping=aes(x=osc_rate, y=M, color=synapse)) +
    ...
    labs(title="e.", y="Pop. rate", x="Osc. modulation") +
    lims(y=c(0.0, 180.0)) +
    theme_classic2() +
  theme(
...
```
# Figure: Gamma (AMPA)
```{r, fig.height=2.1, fig.width=2.8}
freq_labels <- as_labeller(c('60' = "Gamma, 60 Hz", '90' = "Gamma, 90 Hz"))
gamma_results %>% 
  ...
  labs(y="Pop. rate", x="Osc. modulation", tag="a.") +
  lims(y=c(0, 100)) +
...
gamma_results %>% 
  ...
  theme(legend.position = "none",
        ...
        panel.grid.minor = element_blank(),
        strip.background = element_blank()) +
  labs(y="Kappa", x="Osc. modulation", tag="b.") -> p2
...
grid.arrange(p1, p2, pn,layout_matrix=layout_matrix)

png(file="fig3.png", bg="white", width=5.6, height=4.2, unit="in", res=300)
grid.arrange(p1, p2, pn,layout_matrix=layout_matrix)
dev.off()
```

# Figure: FI 
```{r, fig.height=0.9, fig.width=1.9}
win <- 50e-3
N <- 100
uamp <- 1e6
results_fi %>% 
ggplot() +
  geom_line(aes(x=impulse*uamp, y=rate_ref/win/N, color="No homeostatis"), size=0.8) +
  geom_line(aes(x=impulse*uamp, y=rate_h/win/N, color="Homeostatis"), size=0.8) +
  labs(tag="a.", y="Pop. rate", x=TeX("Impulse ($\\mu$amps)")) +
  lims(x=c(0, 10)) +
...
png(file="fig4.png", bg="white", width=3.8, height=1.8, unit="in", res=300)
print(p1)
dev.off()
```
...
results_control_drift %>% 
  ...
  geom_point(size=1.5) +
  theme_classic() +
  labs(tag="d.", y="Pop. rate", x="Osc. modulation") +
  lims(y=c(0.0, 100.0)) +
  theme(
...
results_control_drift %>% 
  ...
  geom_point(size=1.5) +
  theme_classic() +
  labs(tag="e.", y="Kappa", x="Osc. modulation") +
  lims(y=c(0.0, 0.2)) +
  theme(legend.position = "none",
        plot.tag = element_text(size=18, face="bold")) +
  scale_color_manual(
...
results_control_leak %>% 
  ...
  theme(
    ...
    legend.background = element_rect(colour ="black"),
    plot.tag = element_text(size=18, face="bold")) +
  labs(tag="f.", y="Pop. rate", x="Osc. modulation") +
  scale_color_manual(
...
results_control_leak %>% 
  ...
  theme(legend.position = "none",
        plot.tag = element_text(size=18, face="bold")) +
  labs(tag="g.", y="Kappa", x="Osc. modulation") +
...
png(file="fig5.png", bg="white", width=10, height=7.2, unit="in", res=300)
grid.arrange(p1, p2, p3, p4, p5, p6, p8, p9, p10, p11, p12, p13, p14, p15, layout_matrix=layout_matrix)
dev.off()
```
